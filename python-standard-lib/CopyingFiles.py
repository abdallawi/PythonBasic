...
source = Path('/home/eliot/PycharmProjects/python_basics/python-standard-lib/txt-files/Intro.txt')

# We make 2 different Path objects to play with, one exist to other will be used to create a new file:

target_must_exist = Path('/home/eliot/PycharmProjects/python_basics/python-standard-lib/copy-txt-files/BlankIntro.txt')
target_will_be_created = Path('/home/eliot/PycharmProjects/python_basics/python-standard-lib'
                              '/copy-txt-files/CopyIntro.txt')
