...
# We need the subprocess module, this will allow us to create a child process [This way we can start another program].
...
# We will start with an easy example in Linux we have the 'ls' command [dir on Windows]
